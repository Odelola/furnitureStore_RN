...
export default SkeleteonLoader = () => (
    ...
    <View className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
        <View className="flex items-center justify-center w-full h-48 bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
